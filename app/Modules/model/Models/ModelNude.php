...
class ModelNude extends Model
{
    protected $table='model_nude';
    /**
...
//        echo $limit;
//        exit;
        return ModelNude::select('id', 'name', 'email', 'address', 'phone', 'avatar', 'round_brest as roundBrest')->take($limit)->skip($start)->whereRaw($condition, $value)->orderBy($field_order,$order)->get()->toArray();
    }
